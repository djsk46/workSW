...
<body>
	...
	<c:forEach var="nRow" items="${list}">
		<div style="width: 120px; float: left;">${nRow.CODE }</div>
			<div style="width: 300px; float: left;"><a href="./commonCodeDetail.ino?code=${nRow.CODE }" onclick="window.open('./commonCodeDetail.ino?code=${nRow.CODE }','','width=800,height=600,left=600'); return false;">${nRow.CODE_NAME }</a></div>
